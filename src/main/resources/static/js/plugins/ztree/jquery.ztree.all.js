            ...
            asyncNode: function (setting, node, isSilent, callback) {
                ...
                $.ajax({
        			...
        			beforeSend: function(request) {
        				console.dir(CommonUtil.getHeaders());
        	            request.setRequestHeader("token", CommonUtil.getHeaders().systemToken);
        	            request.setRequestHeader("ecmId", CommonUtil.getHeaders().systemEcmId);
        	            request.setRequestHeader("ecmName", encodeURI(CommonUtil.getHeaders().systemEcmName));
        	        },

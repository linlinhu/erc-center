...
$(function(){
    ...
    jQuery.validator.addMethod("isTel", function(value,element) {   
        var len = value.length;
        var mobbile = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;   
        var tel = /\d{3}-\d{8}|\d{4}-\d{7}/;  
        return this.optional(element) || tel.test(value) || mobbile.test(value);
    }, "请正确填写您的联系方式"); 
    ...
    $.validator.addMethod("isEmail",function(value, element, params){  
        var isEmail = /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-]{1,10})+$/;  
